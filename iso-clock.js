...
function make()
{
	...
	const old_clock = clock_container.get_child_at_index(clock_index);
	...
	$.enable = function() {
		update_clock();
		clock_container.remove_child(old_clock);
	...
	$.disable = function() {
		...
		clock_container.insert_child_at_index(old_clock, clock_index);
	}
